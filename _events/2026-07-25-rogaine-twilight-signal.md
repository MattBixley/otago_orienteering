...
run it hard or wander it with the family.

## Register

Entries are via a Google Form and **close midnight Tuesday 21 July** so we can
print maps. Bring a headtorch — the light will be going.

> Map handout follows the [School Series Prizegiving](/events/2026-07-25-school-series-prizegiving/)
> at the Signal Hill MTB carpark.
